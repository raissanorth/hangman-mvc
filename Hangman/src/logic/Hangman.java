...
chars in target String
display chars guessed correctly by user
placeholder _ for chars not revealed yet
? visual output for guesses taken/limit

x target String
x int limit
x int guesses
x create Scanner object to read user input
x GameOver when guesses >= limit
